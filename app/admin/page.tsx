...
export default function AdminPanel() {
  ...
  if (!authed) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FAF6F1', direction: 'rtl' }}>
        <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', width: '320px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px', border: '1px solid #E8C5C0', borderRadius: '8px', marginBottom: '12px', fontSize: '16px', boxSizing: 'border-box' }}
          />
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#FAF6F1', direction: 'rtl', padding: '24px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        <h1 style={{ fontFamily: 'serif', fontStyle: 'italic', fontSize: '32px', color: '#8FAF8A', marginBottom: '24px' }}>
          🌸 لوحة تحكم LanaFleur
        </h1>
              ...
              <div key={p.id} style={{ backgroundColor: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                ...
                <div style={{ padding: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                    ...
                    {p.badge && (
                      <span style={{ fontSize: '11px', backgroundColor: '#E8C5C0', padding: '2px 8px', borderRadius: '10px' }}>
                        {p.badge}
                      </span>
                    )}
                  </div>
